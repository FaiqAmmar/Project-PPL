...
<div class="h-[85vh] mx-4 mt-4 mb-4 rounded bg-[#D6E8EE]">
  <div class="flex items-center pl-10 pr-14 pt-10">
    <a href="/konsultasi" class="flex flex-row items-center py-2 px-3 h-10 bg-[#A4E1FF] rounded-xl">
  ...
  <div id="scrollbar" class="relative h-2/3 overflow-y-auto mx-10 px-4 mt-4 py-4 bg-[#A4E1FF] rounded-xl">
