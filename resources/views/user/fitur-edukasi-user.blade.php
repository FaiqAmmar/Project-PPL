    ...
    <div class="px-9 py-3">
      <div class="flex items-center justify-between">
        ...
        <img class="w-8 h-8 rounded-full" src="{{ asset('storage/logo.png') }}" alt="logo">
          <a class="ml-10 self-center text-xl font-semibold sm:text-base whitespace-nowrap underline underline-offset-8 text-black" href="fitur-edukasi-user">Edukasi</a>
