      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="px-2 py-2">
            ...
            type="button" data-modal-target="modal-edit" data-modal-toggle="modal-edit">
            ...
            <form action="{{ route('update.bahan-ajar', $tablemodul->id) }}" method="post">
              ...
              @method('PUT')
                <!-- Modal Konfirmasi -->
                <div id="modal-edit" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full h-[calc(100%-1rem)] max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                      ...
                      <div class="flex flex-col justify-center px-6 pb-4">
                        ...
                        <div class="flex flex-row gap-12 justify-center mt-4">
                          <button type="button" class="w-1/3 transition-all text-white bg-[#FF0000] hover:bg-[#ff4747] focus:ring-inset focus:ring-4 focus:outline-none shadow-inner focus:shadow-2xl focus:bg-[#cc0000] focus:ring-[#ff4747] font-medium rounded-lg text-sm px-5 py-2.5 text-center" data-modal-hide="modal-edit">Batal</button>
