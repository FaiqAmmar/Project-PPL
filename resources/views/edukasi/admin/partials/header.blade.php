<div class="flex flex-row w-auto h-12 m-4 rounded bg-[#7FC7D9] items-center p-2">
          ...
          @foreach ($jenis as $item)
              <li class="me-2">
                  <a href="/admin/edukasi/{{ $item->id }}" rel="noopener noreferrer"><button
                          class="bg-[#D6E8EE] rounded-xl text-center px-3 py-1.5"
                          type="button">
  ...
  <button id="tambahJenisModal" type="submit" data-modal-target="tambahJenisModal"
