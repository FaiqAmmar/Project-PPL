    ...
    <table class="text-xs w-full text-left">
      <thead class="font-bold text-white bg-[#48B477]">
        <tr>
          ...
          <th scope="col" class="w-auto px-2 py-2">Email</th>
              ...
              <div class="bg-[#EEEEEE] border-[#48B477] border-2 rounded-lg">
                ...
                <div class="flex flex-col items-center">
                  ...
                  <div class="flex flex-col items-center px-8 pb-1 gap-0 w-full">
                    ...
                    <div class="bg-[#E5E5E5] w-full py-1 px-2 text-left text-sm rounded-md ">{{$seegov->nama}}</div>
                  </div>
                  <div class="flex flex-col items-center px-8 pb-1 gap-0 w-full">
                    <label class="w-full text-left pl-2 font-medium" for="email">Email</label>
                    <div class="bg-[#E5E5E5] w-full py-1 px-2 text-left text-sm rounded-md ">{{$seegov->email}}</div>
                  </div>
                  <div class="flex flex-col items-center px-8 pb-1 gap-0 w-full">
                    <label class="w-full text-left pl-2 font-medium" for="nomor_handphone">Nomor Handphone</label>
                    <div class="bg-[#E5E5E5] w-full py-1 px-2 text-left text-sm rounded-md ">{{$seegov->nomor_handphone}}</div>
                  </div>
                  <div class="flex flex-col items-center px-8 pb-1 gap-0 w-full">
                  ...
                  <div class="flex flex-col items-center px-8 pb-3 gap-0 w-full">
                    ...
                    >{{$seegov->alamat}}, {{$seegov->district_name}}, {{$seegov->city_name}}, {{$seegov->province_name}}</textarea>
                  </div>
                </div>
              </div>
            </div>
