...
<section>
  <div class="bg-[#FEFEFE]">
    <div class="flex flex-row pl-10 gap-24 ">
      <div class="flex flex-col w-5/6">
        <div class="pt-12 pb-14 px-16 max-w-lg flex-auto my-20 text-left bg-slate-100 rounded-3xl shadow-[10px_10px_0px_0px_rgba(0,0,0,0.3)]">
          ...
          <div class="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
            <a href="login" class="rounded-md bg-slate-700 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm 
            hover:bg-slate-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white 
            hover:scale-110 hover:shadow-2xl transition-all duration-100">Masuk</a>
            <a href="register-role" class="rounded-md bg-white ring-slate-700 ring-2 px-3.5 py-2.5 text-sm font-semibold text-slate-700 shadow-sm 
  ...
  <div class="flex justify-center items-center mt-[46px] h-10 font-poppins tracking-wide font-bold bg-[#D6E8EE]">
    ©2024 AgroEdu
  </div>
</section>
